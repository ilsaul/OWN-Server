...
/**
 * This Engine use the use a self made connector to talk with the bus scs. I don't sell this
 * component but you can ask guidopic.
 *
...
public class Row implements Engine, SerialPortEventListener {
	...
	public Row() throws PortInUseException, NoSuchPortException, UnsupportedCommOperationException, IOException, TooManyListenersException {
		serialPort = null;
		in = null;
		out = null;
		dirtyBuffer = null;
	...
	public void connect() throws PortInUseException, NoSuchPortException, UnsupportedCommOperationException, IOException, TooManyListenersException {
		connect(Config.getInstance().getNode("row"));
	}
	...
	private void connect(String portName) throws PortInUseException, NoSuchPortException, UnsupportedCommOperationException, IOException, TooManyListenersException {
		...
		if (portIdentifier.isCurrentlyOwned()) {
			...
			if (commPort instanceof SerialPort) {
				...
				logger.info("Row Engine Connected");
